...
--
-- Host: localhost
-- Generation Time: Jul 24, 2019 at 02:40 AM
...
('P01', 'Cervical Syndrome', 'Cervical Syndrom adalah penyakit yang menyerang tulang belakang pada bagian cervical atau bagian belakang leher.', 'Silahkan lakukan medical check up untuk mendapat perawatan lebih lanjut mengenai penyakit anda'),
('P02', 'Heria Nukleus Pulposus', 'Hernia Nulekus Pulposus \r\nsering disebut dengan \"Saraf Kejepit\" adalah kondisi ketika bantalan atau cakram di antara vertebrata (tulang belakang) keluar dari posisi semula dan menjepit saraf yang berada di belakangnya', 'Silahkan lakukan medical check up untuk mendapat perawatan lebih lanjut mengenai penyakit anda '),
('P03', 'Low Back Pain', 'Low Back Pain atau nyeri punggung bawah bisa dialami siapa saja. Pada prinsipnya, LBP merupakan nyeri yang dirasakan pada bagian punggung bawah yang dapat merupakan nyeri lokal (hanya di bagian pinggang atau lumbal), nyeri radikuler (menjalar ke tung', 'Silahkan lakukan medical check up untuk mendapat perawatan lebih lanjut mengenai penyakit anda'),
('P04', 'Muscle Strain', 'Kemungkinan anda mengalami muscle strain, muscle strain atau yang biasa disebut salah bantal adalah suatu kondisi otot yang tegasng atau tertarik, terjadi saat otot teriritasi atau bahkan robek. Hal ini biasa terjadi akibat kelelahan atau penggunaan ', 'Beristirahat dan mulailah pelemasan otot, kompres bagian yang sakit dengan es batu, gunakan bantal yang tepat saat ingin tidur. Bila rasa sakit berkepanjangan silahkan lakukan medical check up untuk mengetahui penyakit lebih jelasnya'),
('P05', 'Migrain', 'Kemungkinan anda megalami migrain, migrain adalah sakit kepala yang terasa berdenyut, dan biasanya terjadi pada satu sisi kepala saja. Migrain merupakan penyakit saraf, yang dapat menimbulkan gejala, seperti mual, muntah, serta sensitif terhadap caha', 'Minum obat pereda sakit, bila sakit masih terasa berkepanjangan silahkan melakukan pemeriksaan ke klinik atau rumah sakit'),
('P06', 'Frozen Shoulder', 'Frozen shoulder adalah kondisi nyeri bahu yang membuat bahu susah digerakkan. Nyeri bahu ini mengakibatkan ruang di dalam sendi bahu mengecil secara bertahap.\r\nFrozen shoulder adalah kondisi yang dapat berkembang dalam beberapa fase. Pada tahap pertama, Anda mulai merasakan nyeri bahu dan tangan sulit bergerak. Tahap ini biasanya berlangsung sekitar 4 bulan. ', 'Gunakan obat seperti yang diarahkan oleh dokter, olahraga sesuai saran dokter, ikuti bimbingan dari ahli fisioterapi, biasakan bergerak secara normal, sebab bahu yang jarang digerakkan justru menjadi penyebab penyakit ini dan jika rasa sakit berkepanjangan silahkan melakukan medical check up'),
('P07', 'Peradangan Sendi', 'Peradangan bisa terjadi dimana saja pada tubuh Anda, terutama di sekitar sendi. Bila peradangan terjadi pada sendi bahu dapat disebabkan oleh rheumatoid arthritis (rematik).  Sementara peradangan yang terjadi pada kartilago (tulang rawan) disebut dengan osteoarthritis.\r\n\r\nKedua kondisi ini bisa disebabkan oleh kesalahan sistem imun, infeksi, dan penuaan tulang. Tanpa perawatan yang tepat, tidak hanya sendi, saraf di sekitar sendi yang meradang juga bisa rusak. ', 'Untuk mengurangi rasa sakit, biasanya digunakan obat antiinflamasi nonsteroid atau OAINS (misalnya ibuprofen atau diclofenac), analgesik (misalnya paracetamol atau tramadol), serta mengoleskan krim atau salep yang mengandung capsaicin atau mentol. Jika rasa sakit masih terasa dalam waktu yang cukup lama segera lakukan medical check up'),
('P08', 'Kram Otot', 'Kemungkinan anda mengalami kram otot, kram bisa menyerang kapan saja dan secara tiba-tiba, walaupun dalam keadaan tidur di tengah malam. Tungkai bawah adalah salah satu bagian tubuh yang kerap dilanda kram. Kram di bagian tungkai kaki ini disebut â€œ', 'Untuk meredakan kram Kamu bisa minum air putih dan meluruskan kaki dan memijat bagian yang kram dengan perlahan. Untuk mencegah kram datang kembali, sebelum berolahraga jangan lupa melakukan peregangan. '),
('P09', 'Gangguan Muskuloskeletal ', 'Untuk nyeri ringan atau sesekali, Anda bisa mendapatkan obat pereda nyeri yang dijual bebas, seperti ibuprofen atau paracetamol. Obat-obatan seperti obat anti-inflamasi (NSAID) dapat digunakan untuk mengobati peradangan dan nyeri, tetapi jika sakit berlanjut segera lakukan medical check up', 'Untuk nyeri ringan atau sesekali, Anda bisa mendapatkan obat pereda nyeri yang dijual bebas, seperti ibuprofen atau paracetamol. Obat-obatan seperti obat anti-inflamasi (NSAID) dapat digunakan untuk mengobati peradangan dan nyeri, jika rasa sakit berlanjut segera lakukan medical check up. '),
('P10', 'Mati Rasa atau Baal', 'Kemungkinan anda mengalami mati rasa, mati rasa alias baal adalah kondisi di mana Anda tidak dapat merasakan apapun. Kondisi ini terjadi, karena tidak tersalurkannya rangsangan pada saraf Anda, yang bertujuan dalam mengirimkan sinyal rasa pada tubuh Anda. Mati rasa disertai dengan timbulnya rasa kesemutan dan sensasi rasa terbakar. Pada sebagian besar kasus, mati rasa sering terasa pada jari, tangan, kaki, lengan, maupun telapak kaki Anda. ', 'Gerakan bagian yang mengalami mati rasa secara perlahan, ubah posisi duduk (jika anda sedang duduk), kurangi penggunaan pakaian ketat, pijat bagian yang mengalami mati rasa secara lembut dan perlahan. Jika mati rasa tidak hilang dalam waktu lama segera lakukan medical check up agar dapat mengetahui penyakitnya lebihlanjut.');
...
('R04', 'G01', 'Muscle Strain'),
('R05', 'G02', 'Migrain'),
('R06', 'G03', 'Frozen Shoulder'),
('R07', 'G04', 'Peradangan Sendi'),
('R08', 'G05', 'Kram Otot'),
('R09', 'G06', 'Gangguan Muskuloskeletal '),
('R10', 'G07', 'Mati Rasa atau Baal'),
('R11', 'G04,G05,G06,G07,G08', 'Migrain'),
('R12', 'G01,G02,G03,G04,G05', 'Cervical Syndrome');
